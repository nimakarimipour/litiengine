...
public class CustomProperty implements ICustomProperty {
     ...
     *          The value of this custom property.
     */
    public CustomProperty(@Nullable String type, String value) {
    ...
    public char getAsChar() {
        // TODO Is this enough? Should it check if it's the right length and throw an exception if it's not?
