...
public class ImageComponent extends GuiComponent {
    ...
    @Initializer
    public ImageComponent(final double x, final double y, final double width, final double height, @Nullable final Spritesheet spritesheet, final String text, @Nullable final Image image) {
