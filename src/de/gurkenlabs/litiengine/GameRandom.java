...
public final class GameRandom extends java.util.Random {
   ...
   */
  @NullUnmarked public <T> T choose(T[] array) {
   ...
   */
  @NullUnmarked public <T> T choose(Collection<T> coll) {
   ...
   */
  @NullUnmarked public Color nextColor(Color originalColor, float colorVariance, float alphaVariance) {
