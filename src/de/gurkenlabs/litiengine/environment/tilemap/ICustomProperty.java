...
public interface ICustomProperty {
  ...
  /**
   * Tests for equality between two custom properties. Two custom properties are <i>equal</i> if
   * they both have the same type and string value.
   *
   * @param anObject The custom property to test equality for
   * @return Whether the two custom properties are equal, or false if {@code anObject} is not a
   *     custom property
   */
  public boolean equals(Object anObject);

  /**
   * Returns the hash code for this custom property. The hash code for a custom property is equal to
   * its type's hash code times 31 plus its value's hash code.
   *
