...
public final class ColorHelper {
   ...
   */
  @NullUnmarked public static String encode(Color color) {
    if (color == null) {
      return null;
    }
  ...
  @NullUnmarked public static Color decode(String colorHexString, boolean solid) {
  ...
  @NullUnmarked private static Color decodeWellformedHexString(String hexString) {
    try {
  ...
  @NullUnmarked private static Color decodeHexStringWithAlpha(String hexString, boolean solid) {
