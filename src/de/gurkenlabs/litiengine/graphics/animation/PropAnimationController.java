...
public class PropAnimationController<T extends Prop> extends EntityAnimationController<T> {
  ...
  @NullUnmarked private static Animation createAnimation(final Prop prop, final PropState state) {
  ...
  @NullUnmarked private static Spritesheet findSpriteSheet(final Prop prop, final PropState state) {
