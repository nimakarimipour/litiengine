...
public interface ILayerList extends ICustomPropertyProvider {
   ...
   */
  @NullUnmarked public default IMapObjectLayer getMapObjectLayer(IMapObject mapObject) {
  ...
  @NullUnmarked public default IMapObjectLayer getMapObjectLayer(String layerName) {
  ...
  @NullUnmarked public default IMapObjectLayer getMapObjectLayer(int layerId) {
   ...
   */
  @NullUnmarked public default IMapObject getMapObject(int mapId) {
    if (this.getMapObjectLayers() == null) {
      return null;
    }
