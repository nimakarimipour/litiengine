...
public class EntityPivotTests {
  @Test
  public void getPoint_typeLOCATION_default() {
    // arrange
  ...
  @Test
  public void getPoint_typeLOCATION_specific() {
    // arrange
    Creature executor = mock(Creature.class);
  ...
  @Test
  public void getPoint_typeOFFSET_specific() {
    // arrange
    Creature executor = mock(Creature.class);
    when(executor.getX()).thenReturn(-1d);
    when(executor.getY()).thenReturn(-1d);
  ...
  @Test
  public void getPoint_typeOFFSET_withOffset() {
    // arrange
    Creature executor = mock(Creature.class);
    when(executor.getX()).thenReturn(1d);
    when(executor.getY()).thenReturn(1d);
  ...
  @Test
  public void getPoint_typeDIMENSIONCENTER() {
    // arrange
    Creature executor = mock(Creature.class);
  ...
  @Test
  public void getPoint_typeCOLLISIONBOXCENTER() {
    // arrange
    Creature executor = mock(Creature.class);
