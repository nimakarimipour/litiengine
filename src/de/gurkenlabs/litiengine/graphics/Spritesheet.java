...
public final class Spritesheet implements Comparable<Spritesheet> {
     ...
     */
    public Spritesheet(final BufferedImage image, @Nullable final String path, final int spriteWidth, final int spriteHeight) {
    ...
    private static void checkImage(BufferedImage image, @Nullable String name) {
        if (image == null) {
