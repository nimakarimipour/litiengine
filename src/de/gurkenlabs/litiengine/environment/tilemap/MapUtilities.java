...
public final class MapUtilities {
  ...
  @NullUnmarked public static ITile getTopMostTile(final Point2D location) {
  ...
  @NullUnmarked public static ITile getTopMostTile(final IMap map, final Point2D location) {
    if (map.getTileLayers() == null || map.getTileLayers().isEmpty()) {
      return null;
    }
  ...
  @NullUnmarked public static ITile getTopMostTile(final Point point) {
    if (Game.world().environment() == null || Game.world().environment().getMap() == null) {
      return null;
    }
  ...
  @NullUnmarked public static ITile getTopMostTile(final IMap map, final Point point) {
   ...
   * @return the tileset
   */
  @NullUnmarked public static ITileset findTileSet(final IMap map, final ITile tile) {
  ...
  @NullUnmarked public static Path2D convertPolyshapeToPath(final IMapObject mapObject) {
  ...
  @NullUnmarked public static IMapObject findMapObject(final IMap map, final int id) {
  ...
  @NullUnmarked private static final IMap getCurrentMap() {
    if (Game.world().environment() == null) {
      return null;
    }
