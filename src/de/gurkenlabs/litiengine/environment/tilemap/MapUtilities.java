...
public final class MapUtilities {
    ...
    @Nullable
    public static ITile getTopMostTile(@Nullable final IMap map, final Point2D location) {
        if (map.getTileLayers() == null || map.getTileLayers().isEmpty()) {
            return null;
        }
    ...
    @Nullable
    public static ITile getTopMostTile(@Nullable final IMap map, final Point point) {
