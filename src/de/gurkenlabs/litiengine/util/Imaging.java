...
public final class Imaging {
  ...
  @Nullable public static BufferedImage flipSpritesHorizontally(@Nullable final Spritesheet sprite) {
  ...
  @Nullable public static BufferedImage scale(@Nullable final BufferedImage image, final int width, final int height, final boolean keepRatio) {
  ...
  @NullUnmarked @Nullable private static BufferedImage flipSprites(@Nullable final Spritesheet sprite, UnaryOperator<BufferedImage> flipFunction) {
