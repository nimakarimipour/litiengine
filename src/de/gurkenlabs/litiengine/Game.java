...
public final class Game {
  ...
  public static GameWindow window() {
    if (gameWindow == null) {
      throw new IllegalStateException("GameWindow is not initialized");
    }
    return gameWindow;
  }
   ...
   * {@code GameWorld.reset(String)} method is called. Moreover, it provides the possibility to
   * attach game logic via {@code EnvironmentListeners} to different events of the {@code
   * Envrionment's} life cycle (e.g. loaded, initialized, ...).<br>
