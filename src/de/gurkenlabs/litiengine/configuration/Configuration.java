...
public class Configuration {
   ...
   */
  @NullUnmarked public <T extends ConfigurationGroup> T getConfigurationGroup(final Class<T> groupClass) {
  ...
  @NullUnmarked public ConfigurationGroup getConfigurationGroup(final String prefix) {
    for (final ConfigurationGroup group : this.getConfigurationGroups()) {
