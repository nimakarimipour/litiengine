...
public interface ITileLayer extends ILayer {
   ...
   *
   * <p>To retrieve map grid coordinates from a location on the map, use the {@code
   * MapUtilities#getTile(Point2D)} method.
   *
   * @param x The x-coordinate (on the map grid) to retrieve the tile.
   * @param y The y-coordinate (on the map grid) to retrieve the tile.
   ...
   * @param tile The tile that provides the tile id to be set on the tile at the specified location.
   * @see ITile#getGridId()
   */
   ...
   * @param x The x-coordinate (on the map grid).
   * @param y The y-coordinate (on the map grid).
   * @param gid The id to be set on the tile at the specified location.
   */
