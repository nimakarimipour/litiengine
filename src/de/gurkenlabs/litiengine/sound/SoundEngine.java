...
public final class SoundEngine implements IUpdateable, ILaunchable {
   ...
   */
  @Nullable public MusicPlayback playMusic(String musicName) {
   ...
   * @return The playback of the music
   */
  @Nullable public MusicPlayback playMusic(@Nullable Sound music) {
   ...
   * @return The playback of the music
   */
  @Nullable public MusicPlayback playMusic(Track track) {
   ...
   * @return The playback of the music
   */
  @Nullable public MusicPlayback playMusic(Track track, boolean restart) {
   ...
   * @return The playback of the music
   */
  @Nullable public MusicPlayback playMusic(Track track, boolean restart, boolean stop) {
   ...
   * @return The playback of the music
   */
  @Nullable public synchronized MusicPlayback playMusic(Track track, @Nullable Consumer<? super MusicPlayback> config, boolean restart, boolean stop) {
   ...
   */
  @Nullable public synchronized MusicPlayback getMusic() {
    return music;
  }
   ...
   */
  @Nullable public SFXPlayback playSound(@Nullable final Sound sound, final IEntity entity) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final String soundName, final IEntity entity) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(@Nullable final Sound sound, final IEntity entity, boolean loop) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final Sound sound, final IEntity entity, boolean loop, int range) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(@Nullable final Sound sound, final IEntity entity, boolean loop, int range, float volume) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final String soundName, final IEntity entity, boolean loop) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final Sound sound, final Point2D location) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final String soundName, final Point2D location) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final Sound sound, double x, double y) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final String soundName, double x, double y) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(@Nullable final Sound sound, final Point2D location, boolean loop) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final Sound sound, final Point2D location, boolean loop, int range) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final Sound sound, final Point2D location, boolean loop, int range, float volume) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final String soundName, final Point2D location, boolean loop) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final Sound sound, final double x, final double y, boolean loop) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final String soundName, final double x, final double y, boolean loop) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final Sound sound) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final String soundName) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(@Nullable final Sound sound, boolean loop) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final Sound sound, boolean loop, int range) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final Sound sound, boolean loop, int range, float volume) {
   ...
   *         and control the played sound.
   */
  @Nullable public SFXPlayback playSound(final String soundName, boolean loop) {
   ...
   */
  @Nullable public SFXPlayback createSound(Sound sound, Supplier<Point2D> supplier, boolean loop, int range, float volume) {
    try {
  ...
  @Nullable private SFXPlayback playSound(@Nullable Sound sound, Supplier<Point2D> supplier, boolean loop, int range, float volume) {
    if (sound == null) {
      return null;
    }
