...
public class SpeechBubbleAppearance extends Appearance {
    ...
    public SpeechBubbleAppearance(Color foreColor, Color backColor, @Nullable Color borderColor) {
        super(foreColor, backColor);
        this.borderColor = borderColor;
    }

    public SpeechBubbleAppearance(Color foreColor, Color backColor, @Nullable Color borderColor, float padding) {
