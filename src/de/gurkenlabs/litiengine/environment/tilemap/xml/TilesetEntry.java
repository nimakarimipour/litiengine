...
public class TilesetEntry extends CustomPropertyProvider implements ITilesetEntry {
  ...
  public BufferedImage getImage() {
    ...
    ITilesetEntry iTilesetEntry = this.tileset.getTile(this.animation.getCurrentFrame().getTileId());
    return iTilesetEntry == null ? null : iTilesetEntry.getBasicImage();
  }
  ...
  public BufferedImage getBasicImage() {
    ...
    Spritesheet spritesheet = this.tileset.getSpritesheet();
    if(spritesheet == null){
      return null;
    }
