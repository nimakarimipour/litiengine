...
public interface ICustomPropertyProvider {
   ...
   * provided default value is used as a fallback.
   *
   * @param propertyName the name of the custom property
   ...
   * @throws NoSuchElementException if the custom property does not exist
   * @throws NumberFormatException if the custom property is not an integer or is not in range for
   *     an {@code int}
   */
  public int getIntValue(String propertyName);

  /**
   * Gets the int value of the custom property with the provided name. If the value is null, the
   * provided default value is used as a fallback.
   *
   * @param propertyName the name of the custom property
   * @param defaultValue the fallback value in case the property value is null.
   * @return the int value of the custom property, if present. Otherwise, the provided default value
   *     is returned.
   */
   ...
   * @throws NoSuchElementException if the custom property does not exist
   * @throws NumberFormatException if the custom property is not an integer or is not in range for a
   *     {@code long}
   */
  ...
  /**
   * Gets the long value of the custom property with the provided name. If the value is null, the
   * provided default value is used as a fallback.
   *
   * @param propertyName the name of the custom property
   * @param defaultValue the fallback value in case the property value is null.
   * @return the long value of the custom property, if present. Otherwise, the provided default
   *     value is returned.
   */
   ...
   * @throws NoSuchElementException if the custom property does not exist
   * @throws NumberFormatException if the custom property is not an integer or is out of range for a
   *     {@code short}
   */
  public short getShortValue(String propertyName);

  /**
   * Gets the short value of the custom property with the provided name. If the value is null, the
   * provided default value is used as a fallback.
   *
   * @param propertyName the name of the custom property
   * @param defaultValue the fallback value in case the property value is null.
   * @return the short value of the custom property, if present. Otherwise, the provided default
   *     value is returned.
   */
  ...
  /**
   * Gets the byte value of the custom property with the provided name. If the value is null, the
   * provided default value is used as a fallback.
   *
   * @param propertyName the name of the custom property
   * @param defaultValue the fallback value in case the property value is null.
   * @return the byte value of the custom property, if present. Otherwise, the provided default
   *     value is returned.
   */
  ...
  /**
   * Gets the boolean value of the custom property with the provided name. If the value is null, the
   * provided default value is used as a fallback.
   *
   * @param propertyName the name of the custom property
   * @param defaultValue the fallback value in case the property value is null.
   * @return the boolean value of the custom property, if present. Otherwise, the provided default
   *     value is returned.
   */
  ...
  /**
   * Gets the float value of the custom property with the provided name. If the value is null, the
   * provided default value is used as a fallback.
   *
   * @param propertyName the name of the custom property
   * @param defaultValue the fallback value in case the property value is null.
   * @return the float value of the custom property, if present. Otherwise, the provided default
   *     value is returned.
   */
  ...
  /**
   * Gets the double value of the custom property with the provided name. If the value is null, the
   * provided default value is used as a fallback.
   *
   * @param propertyName the name of the custom property
   * @param defaultValue the fallback value in case the property value is null.
   * @return the double value of the custom property, if present. Otherwise, the provided default
   *     value is returned.
   */
  ...
  /**
   * Gets the enum value of the custom property with the provided name. If the value is null, the
   * provided default value is used as a fallback.
   *
   * @param propertyName the name of the custom property
   * @param defaultValue the fallback value in case the property value is null.
   * @param enumType a {@code Class} object for {@code <T>}
   * @param <T> the enum type to use
   * @return the enum value of the custom property, if present. Otherwise, the provided default
   *     value is returned.
   */
  public <T extends Enum<T>> T getEnumValue(String propertyName, Class<T> enumType, T defaultValue);

  /**
   * Gets the file value of the custom property with the provided name. If the property is not a
   * file, {@code null} is returned instead.
   *
   * @param propertyName the name of the custom property
   ...
   * property is not a file, the provided default value is used as a fallback.
   *
   * @param propertyName the name of the custom property
   * @param defaultValue the fallback value in case the property value is null.
   ...
   * when they only exist in the provided properties, and deleted when they only exist in the
   * current properties.
   *
