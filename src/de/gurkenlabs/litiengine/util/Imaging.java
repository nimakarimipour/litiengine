...
public final class Imaging {
  ...
  @Nullable public static BufferedImage scale(final BufferedImage image, final int width, final int height, final boolean keepRatio) {
    return scale(image, width, height, keepRatio, true);
  }

  @NullUnmarked @Nullable public static BufferedImage scale(final BufferedImage image, final int width, final int height, final boolean keepRatio, final boolean fill) {
  ...
  @Nullable private static BufferedImage flipSprites(final Spritesheet sprite, UnaryOperator<BufferedImage> flipFunction) {
