...
public class ImageComponent extends GuiComponent {
    ...
    public ImageComponent(final double x, final double y, final double width, final double height, final Spritesheet spritesheet, final String text, @Nullable final Image image) {
